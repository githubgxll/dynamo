...
`python -m dingo.replay` CLI is part of the Python components, and it imports the
...
```bash
python -m dingo.replay traces/mooncake_fast25/toolagent_trace.jsonl \
  --planner-config '{
    "mode": "agg",

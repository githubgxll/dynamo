...
- **Engine Metrics** (Pass-through) - Backend engines expose their own metrics: [vLLM](../backends/vllm/vllm-observability.md) (`vllm:*`) and [SGLang](../backends/sglang/sglang-observability.md) (`sglang:*`)

...
"""Conftest for dingo.vllm unit tests only.
...
def _can_import_omni() -> bool:
    """Try to import dingo.vllm.omni.base_handler once and cache the result.
    ...
    if _omni_importable is None:
        try:
            importlib.import_module("dingo.vllm.omni.base_handler")
...
def pytest_ignore_collect(collection_path, config):
    ...
    # Omni tests import dingo.vllm.omni.* which transitively imports

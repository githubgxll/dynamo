...
from dingo.vllm.args import configure_rl_logprobs_mode, parse_args
from dingo.vllm.cache_info import (
    configure_kv_event_block_size,
    get_configured_kv_event_block_size,
)
from dingo.vllm.capacity import per_rank_kv_blocks
    ...
    async def from_args(
        ...
        if config.disaggregation_mode == DisaggregationMode.ENCODE:
            raise NotImplementedError(
                ...
                "use `python -m dingo.vllm` for multimodal encode workers"
            )

...
1. Run pre-deployment profiling for your specific setup. See the [pre-deployment profiling documentation](../../../../../../docs/fern/pages/developer-guide/knowledge-base/modular-components/profiler/profiler-guide.md) for detailed instructions.
...
```bash
PYTHONPATH=components/src python -m pytest dingo/planner/tests/unit/test_load_based_scaling.py dingo/planner/tests/plugins/orchestrator -v
```
...
```bash
dingo/planner/tests/manual/scaling/run_scaling_test.sh --namespace <namespace>
```

To save results to `dingo/planner/tests/e2e_scaling_results` instead of `/tmp`:

```bash
dingo/planner/tests/manual/scaling/run_scaling_test.sh --namespace <namespace> --save-results
```

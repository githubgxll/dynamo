...
"""Unit tests for load predictor classes in dingo.planner.core.load.predictors."""
...
from dingo.planner.core.load.predictors import (
    ConstantPredictor,
    KalmanPredictor,
    ProphetPredictor,
)
...
class TestProphetPredictorTimestamp:
    ...
    def test_next_timestamp_uses_step_size(self):
        ...
        with patch(
            "dingo.planner.core.load.predictors.Prophet",

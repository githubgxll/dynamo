...
from dingo.planner.core.perf_model import (
    AggRegressionModel,
...
class TestRefreshWorkerInfoFromConnector:
    ...
    def _make_planner(self, require_prefill=False, require_decode=True):
        ...
        with (
            patch("dingo.planner.core.base.PlannerPrometheusMetrics") as mock_metrics,
            patch("dingo.planner.connectors.kubernetes.KubernetesAPI"),

...
from dingo.planner.plugins.registry.auth import MultiSourceAuth
...
def test_static_secret_empty_secrets_logs_warning(caplog):
    with caplog.at_level(
        logging.WARNING, logger="dingo.planner.plugins.registry.config"
    ):
        build_auth_validator(
...
async def test_build_registry_propagates_protocol_versions():
    ...
    from dingo.planner.plugins.types import RegisterRequest

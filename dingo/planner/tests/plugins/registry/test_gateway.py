...
from dingo.planner.plugins.registry.auth import AuthIdentity, AuthValidator
from dingo.planner.plugins.registry.circuit_breaker import CircuitBreaker
from dingo.planner.plugins.registry.errors import AuthError
from dingo.planner.plugins.registry.gateway import PluginRegistryGatewayServicer
from dingo.planner.plugins.registry.server import PluginRegistryServer
from dingo.planner.plugins.transport.base import PluginTransport
...
async def _register(server, plugin_id="p1", auth_token="A"):
    ...
    from dingo.planner.plugins._proto_bridge import proto_to_pydantic
...
async def test_start_gateway_server_raises_when_port_zero():
    ...
    from dingo.planner.plugins.registry import gateway as gw_mod

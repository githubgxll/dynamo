...
from dingo.planner.plugins.registry.config import InProcessPluginSpec
...
FAKE_PLUGIN_MODULE = "dingo.planner.tests.plugins.orchestrator._fake_in_process_plugin"
...
def test_loader_raises_on_unknown_module(ctx_factory):
    ...
    spec = InProcessPluginSpec.model_validate(
        {
            "module": "dingo.planner.tests.plugins.orchestrator.does_not_exist",
            "class": "Missing",
            "plugin_id": "x",
            "plugin_type": "propose",
            "priority": 1,

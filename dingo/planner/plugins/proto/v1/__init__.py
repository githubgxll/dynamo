...
# dingo.planner.plugins.proto.v1 import plugin_pb2``. When the generated
    ...
    *use* one of the dummy classes at runtime gives a useful error
    ...
    def __getattr__(self, name: str):  # type: ignore[no-untyped-def]
        ...
        msg = (
            ...
            "missing. Run protoc per dingo/planner/plugins/"
...
for _stub_name in ("plugin_pb2", "plugin_pb2_grpc"):
    ...
    try:
        ...
        _placeholder.__doc__ = (
            ...
            "``dingo/planner/plugins/proto/v1/README.md`` "

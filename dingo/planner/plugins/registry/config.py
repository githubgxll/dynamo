...
from dingo.planner.plugins.transport.config import TransportConfig
...
if TYPE_CHECKING:
    ...
    from dingo.planner.plugins.registry.auth.base import AuthValidator
...
def build_auth_validator(config: AuthConfig) -> "AuthValidator":
    ...
    from dingo.planner.plugins.registry.auth import (

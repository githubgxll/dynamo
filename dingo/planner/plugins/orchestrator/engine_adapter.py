...
from dingo.common.forward_pass_metrics import encode as _encode_fpm_record

if TYPE_CHECKING:
    import grpc.aio

from dingo.planner.core.budget import (
...
from dingo.planner.plugins.builtins import (
    BuiltinLoadPredict,
    BuiltinLoadPropose,
    BuiltinThroughputPropose,
)
from dingo.planner.plugins.clock import Clock, VirtualClock, WallClock
from dingo.planner.plugins.merge.types import ComponentKey
from dingo.planner.plugins.orchestrator.orchestrator import LocalPlannerOrchestrator
from dingo.planner.plugins.registry.auth import AllowUnauthenticatedAuth
from dingo.planner.plugins.registry.circuit_breaker import CircuitBreaker
from dingo.planner.plugins.registry.config import build_auth_validator
from dingo.planner.plugins.registry.server import PluginRegistryServer
from dingo.planner.plugins.scheduler import PluginScheduler
from dingo.planner.plugins.transport.config import make_transport_for_endpoint
from dingo.planner.plugins.types import (
    FpmData,
    ObservationData,
    PipelineContext,
    TrafficMetrics,
...
class OrchestratorEngineAdapter:
    ...
    def __init__(
        ...
        *,
        ...
        from dingo.planner.monitoring.planner_metrics import PluginFrameworkMetrics
    ...
    def _load_in_process_plugins_from_config(self) -> None:
        ...
        if not specs:
            ...
            return
        from dingo.planner.plugins.orchestrator.in_process_loader import (
    ...
    async def _maybe_start_gateway(self) -> None:
        ...
        from dingo.planner.plugins.registry.gateway import start_gateway_server
    ...
    def _encode_fpm(obs: Optional[FpmObservations]) -> Optional[FpmData]:
        ...
        - per-engine map value = msgpack-encoded ``ForwardPassMetrics``
          via the canonical ``dingo.common.forward_pass_metrics.encode``

...
from dingo.planner.plugins.clock import Clock
from dingo.planner.plugins.merge import (
    ChainAugmentOutcome,
    ComponentKey,
    MergeOutcome,
    PluginResult,
...
from dingo.planner.plugins.merge.types import PredictPluginCallable
from dingo.planner.plugins.registry.circuit_breaker import CircuitBreaker, CircuitState
from dingo.planner.plugins.registry.types import RegisteredPlugin
...
def _result_label(pr: PluginResult) -> str:
    ...
    """
    from dingo.planner.plugins.types import AcceptResult as _AcceptResult
    from dingo.planner.plugins.types import OverrideResult as _OverrideResult
    from dingo.planner.plugins.types import RejectResult as _RejectResult
...
def _set_circuit_state(
    ...
    this tick."""
    from dingo.planner.monitoring.planner_metrics import (

...
from dingo.planner.config.planner_config import AICPerfModelSpec, PlannerConfig
from dingo.planner.core.perf_model.base import _clamp_kv_hit_rate
...
try:  # pragma: no cover - availability depends on the optional Rust feature.
    from dingo.mocker import AicEngineConfig as _AicEngineConfig
    from dingo.mocker import EngineCapacityRequest as _EngineCapacityRequest
    from dingo.mocker import EnginePerfLimits as _EnginePerfLimits
    from dingo.mocker import OptimizationTarget as _OptimizationTarget
    from dingo.mocker import RustEnginePerfModel as _RustEnginePerfModel
    from dingo.mocker import RustEnginePerfOptions as _RustEnginePerfOptions

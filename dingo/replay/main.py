...
from dingo.mocker.utils.kv_cache import compute_kv_bytes_per_token
...
def resolve_planner_profile_data(
    ...
    try:
        module = importlib.import_module("dingo.mocker.args")
    except ImportError:
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m dingo.replay")

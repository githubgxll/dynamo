...
try:
    ...
    from dingo.profiler.profile_sla import (
    ...
    from dingo.profiler.utils.defaults import SearchStrategy
    ...
    from dingo.profiler.utils.dgdr_validate import (
        valid_dgdr_spec,
...
_DGD_GEN = "dingo.profiler.utils.dgd_generation"
...
class TestNaiveFallbackResolvedBackend:
    ...
    def test_naive_fallback_resolved_backend_auto(self):
        ...
        with (
            patch(
                "dingo.profiler.rapid.build_naive_generator_params",
                return_value={},
            ),
            patch(
...
class TestRunProfileSkipsInterpolationForAggConfig:
    ...
    def test_run_profile_skips_interpolation_when_agg(self, tmp_path):
        ...
        try:
            ...
            from dingo.profiler.utils.dgdr_v1beta1_types import FeaturesSpec
        except ImportError as e:
            pytest.skip(f"Missing dependency: {e}")
        ...
        _PROFILE_SLA = "dingo.profiler.profile_sla"
        with (
            patch(
                ...
                return_value=(
                    ...
                    50.0,
                    __import__(
                        "dingo.profiler.utils.defaults", fromlist=["SearchStrategy"]
...
class TestValidateDgdServiceNameLengths:
    ...
    try:
        from dingo.profiler.profile_sla import _validate_dgd_service_name_lengths
    except ImportError:
        pass
    ...
    def test_respects_dgd_name_override(self, monkeypatch):
        ...
        from dingo.profiler.profile_sla import _validate_dgd_service_name_lengths
        from dingo.profiler.utils.dgdr_v1beta1_types import OverridesSpec

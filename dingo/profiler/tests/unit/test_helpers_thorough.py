...
class TestPickThoroughBestConfig:
    ...
    def test_autoscale_calls_pick_autoscale(self):
        ...
        with patch(
            "dingo.profiler.thorough.pick_autoscale", return_value=mock_result
        ) as mock_pick:
    ...
    def test_load_match_uses_request_latency_when_set(self):
        ...
        with patch(
            "dingo.profiler.thorough.pick_load_match", return_value=_mock_result()
        ) as mock_pick:
            _pick_thorough_best_config(
                prefill_df,
                decode_df,
    ...
    def test_default_uses_request_latency_when_set(self):
        ...
        with patch(
            "dingo.profiler.thorough.pick_default", return_value=_mock_result()
        ) as mock_pick:
            _pick_thorough_best_config(
                prefill_df,
                decode_df,

...
Usage::
    ...
    python -m dingo.profiler --config <json string or path to json/yaml>
    python -m dingo.profiler --config '{"model": "Qwen/Qwen3-32B", ...}'
    python -m dingo.profiler --config /path/to/dgdr_spec.yaml
"""

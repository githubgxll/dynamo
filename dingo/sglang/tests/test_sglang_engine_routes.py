...
from dingo.sglang.pause import SGLangEnginePauseController  # noqa: E402
...
def _stub_sglang_io_struct(monkeypatch):
    ...
    monkeypatch.setattr("dingo.sglang.pause.PauseGenerationReqInput", _Req)
    monkeypatch.setattr("dingo.sglang.pause.ReleaseMemoryOccupationReqInput", _Req)
    monkeypatch.setattr("dingo.sglang.pause.ResumeMemoryOccupationReqInput", _Req)
    monkeypatch.setattr("dingo.sglang.pause.ContinueGenerationReqInput", _Req)
    monkeypatch.setattr("dingo.sglang.llm_engine.UpdateWeightFromDiskReqInput", _Req)
    monkeypatch.setattr(
        "dingo.sglang.llm_engine.UpdateWeightsFromTensorReqInput", _Req
    )
    monkeypatch.setattr(
        "dingo.sglang.llm_engine.UpdateWeightsFromDistributedReqInput", _Req
    )
    monkeypatch.setattr("dingo.sglang.llm_engine.UpdateWeightsFromIPCReqInput", _Req)
    monkeypatch.setattr("dingo.sglang.llm_engine.UpdateWeightVersionReqInput", _Req)

...
from dingo.sglang.request_handlers.embedding import embedding_handler as eh
from dingo.sglang.request_handlers.embedding.metrics import (
...
def test_handler_observes_metrics_via_transform_response(monkeypatch):
    ...
    monkeypatch.setattr(
        "dingo.sglang.request_handlers.handler_base.BaseWorkerHandler.__init__",

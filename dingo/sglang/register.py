...
from dingo.sglang.args import DynamoConfig, use_modelexpress_remote_instance
...
def _register_model_source_path(engine: sgl.Engine, server_args: ServerArgs) -> str:
    ...
    `dingo/vllm/main.py`. Diffusion paths (Images/Videos) skip
...
def _build_media_decoder_and_fetcher():
    ...
    Mirrors the vLLM backend pattern (dingo/vllm/main.py).
    """
...
def _get_bootstrap_info_for_config(
    ...
    from dingo.sglang._disagg import compute_bootstrap_address

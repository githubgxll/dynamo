...
from dingo.common import http as mm_http
from dingo.common.http import AiohttpClient, HttpxClient, from_env
...
async def test_legacy_mm_http_env_var_still_honored(monkeypatch) -> None:
    ...
    ``dingo.common.multimodal.http_client`` module still take effect.
    """

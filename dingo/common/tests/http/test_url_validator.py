...
"""Unit tests for ``dingo.common.http.url_validator``.
...
async def test_validate_url_rejects_host_resolving_to_private_ip() -> None:
    with patch(
        "dingo.common.http.url_validator.socket.getaddrinfo",
...
async def test_validate_url_skips_resolution_when_private_allowed() -> None:
    ...
    with patch("dingo.common.http.url_validator.socket.getaddrinfo") as resolver:

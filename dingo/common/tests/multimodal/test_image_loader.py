...
from dingo.common.http import HttpStatusError, HttpTimeoutError
from dingo.common.http.url_validator import UrlValidationPolicy
from dingo.common.multimodal.image_loader import URL_VARIANT_KEY, ImageLoader
...
_FETCH_BYTES_PATH = "dingo.common.multimodal.image_loader.fetch_bytes"

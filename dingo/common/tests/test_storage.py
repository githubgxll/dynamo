...
"""Unit tests for dingo.common.storage module."""

from unittest.mock import MagicMock, patch

import pytest

from dingo.common.storage import get_fs, get_media_url, upload_to_fs
...
class TestGetFs:
    ...
    def test_s3_url_protocol(self):
        ...
        with patch("dingo.common.storage.fsspec.filesystem") as mock_fsspec, patch(
            "dingo.common.storage.DirFileSystem"
        ) as mock_dirfs:

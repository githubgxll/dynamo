...
from dingo.common.backend.engine import GenerateChunk, GenerateRequest
...
def require_encoder_result(
    ...
    Analog of :func:`dingo.common.backend.disagg.require_prefill_result`.

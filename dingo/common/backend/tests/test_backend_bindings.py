...
``dingo.common.backend.Worker`` delegates to. They DO NOT exercise the
...
def test_python_worker_config_coerces_foreign_disaggregation_mode_enum_by_name():
    ...
    same name exists on `dingo.common.constants.DisaggregationMode`.
...
def test_python_worker_config_translates_all_disagg_modes():
    """Every variant of dingo.common.constants.DisaggregationMode must map
    ...
    from dingo.common.backend.worker import _to_rust_disaggregation_mode
    from dingo.common.constants import DisaggregationMode

...
"""Configuration for the ``dingo.common.http`` client.
...
``dingo.common.http`` (whose primary callers don't own an argparse).
...
# ``dingo.common.multimodal.http_client`` module are kept for back
